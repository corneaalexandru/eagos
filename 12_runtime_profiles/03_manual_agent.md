...
Without file-write capability, return a copyable checkpoint and disclose that it was not saved. Without a required tool, complete useful independent preparation and report the dependency. Without demonstrated multi-agent execution, describe roles as logical responsibilities; do not claim a deployed team.

Use the [assurance scenarios](../08_validation_and_assurance.md) to review actual conversation, completion evidence and resumption. This profile does not establish that a particular host/model has passed them.
